...
from EmikoRobot import DEMONS as SUPPORT_USERS
from EmikoRobot import DEV_USERS
from EmikoRobot import DRAGONS as SUDO_USERS
from EmikoRobot import INFOPIC, OWNER_ID
from EmikoRobot import OWNER_USERNAME as AKBOSS
from EmikoRobot import TIGERS
from EmikoRobot import WOLVES as WHITELIST_USERS
from EmikoRobot import StartTime, dispatcher, sw
from EmikoRobot.__main__ import STATS, USER_INFO
from EmikoRobot.modules.disable import DisableAbleCommandHandler
from EmikoRobot.modules.helper_funcs.chat_status import sudo_plus, user_admin
...
from EmikoRobot.modules.users import __user_info__ as chat_count
...
@emikocmd(command="info", pass_args=True)
...
@emikocmd(command="markdownhelp", filters=Filters.chat_type.private)
...
@emikocmd(command="stats", can_disable=False)
@sudo_plus
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + "\n\n[ɢɪᴛʜᴜʙ](https://github.com/MrluckyXD) | [ᴛᴇʟᴇɢʀᴀᴍ](https://t.me/Lobe_ju)\n\n"
            + f"「 ʙʏ[ʟᴜᴄᴋʏ'xᴅ](t.me/{AKBOSS}) 」\n",
